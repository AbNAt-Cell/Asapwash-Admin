...
<body>
  <!-- <div id="main_loader" style="display: none">
    ...
    <div class="book-a-point_Preloader">
      <img src="https://media.giphy.com/media/3oEjI6SIIHBdRxXI40/giphy.gif" alt="Preloader">
    </div>
  </div> -->
  <div id="main_loader">
  ...
  <div class="container">
    <div class="section">
      <div class="column is-6 is-offset-3">
        <center>
          <h1 class="title" style="padding-top: 20px">CarQ Installation</h1><br>
        </center>
        <div class="box">
          <?php
switch ($step) {
...
if ($_POST && isset($_POST["dbscs"])) {
            ...
            ?>
                ...
                <form action="#" id="admin-detal-form" method="POST">
                  ...
                  <div class="field">
                    ...
                    <div class="control">
                      <input class="input" readonly value="123456" type="text" id="password" placeholder="Enter your admin password" name="password" required>
  ...
  <div class="content has-text-centered">
    <p>© <?php echo date('Y'); ?> Copyright AsapDetailing by Abnat</p><br>
  </div>
</body>
